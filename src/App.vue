...
<div id="app">
        ...
        <div class="game-wrapper-single wrapper-stack-2">
            ...
            <div class="lottery-pay-trx-button" style="margin-top: 20px">
                ...
                <div class="referral-link">
                    ...
                    <button class="trx-btn btn-copy" type="button" v-clipboard:copy="message" v-clipboard:success="onCopy" v-clipboard:error="onError">Copy!</button>
    ...
    <p align="center">
        <a class="smart-contract" align="center" href="https://shasta.tronscan.org/?_ga=2.264279631.1391848663.1599805570-527983632.1598499554#/contract/TUwuvejicwVN31XTKE12mKzpjNULo3aMsc/code" target="_blank">Contract: TUwuvejicwVN31XTKE12mKzpjNULo3aMsc</a>
    </p>
